...
def index():
    ...
    cat = categories(headers)
    category_url = f"{cat[-3][1]}/playlists"
    ...
    try:
        ...
        return render_template('index.html', recent_models=RecentModel.query.all(), tracks_models=TopTracksModel.query.all(), categories=cat)
    except:
